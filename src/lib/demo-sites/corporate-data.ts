...
export const CORPORATE_TEAM: CorporateTeamMember[] = [
  {
    ...
    image: demoImage("demos/corporate/team/alex-cheng.jpg"),
  },
  {
    slug: "michelle-yip",
    name: "葉美玲",
    ...
    image: demoImage("demos/corporate/team/michelle-yip.jpg"),
  },
  {
    slug: "david-ho",
    name: "何俊傑",
    ...
    image: demoImage("demos/corporate/team/david-ho.jpg"),
  },
];
...
export const CORPORATE_CASES: CorporateCase[] = [
  {
    ...
    image: demoImage("demos/corporate/cases/fintech-expansion.jpg"),
  },
  {
    slug: "retail-ops",
    client: "連鎖零售品牌",
    ...
    image: demoImage("demos/corporate/cases/retail-ops.jpg"),
  },
  {
    slug: "law-digital",
    client: "本地律師行",
    ...
    image: demoImage("demos/corporate/cases/law-digital.jpg"),
  },
];
