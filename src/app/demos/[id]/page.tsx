...
export default async function DemoHomePage({
  ...
  if (demo.status !== "live" || id !== TEMPLATE_ID) {
    return <DemoComingSoon templateId={id} />;
  }
...
function DemoComingSoon({ templateId }: { templateId: string }) {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-950 px-4 text-center">
      <p className="text-sm text-violet-400">DesignPick 模板展示</p>
